  ...
  def __init__(self, sess, input_shape, action_size, hidden_dims,
    ...
    with tf.variable_scope(scope):
      ...
      with tf.name_scope('advantage'):
        ...
        pivot = 0
        rows = []
        # building L matrix:[paper:] L is a lower triangular matrix generated by linear ouput layer of nn,
    ...
    # x = observation, u = action, mu = policy, V = value function, Q = Q function, P = L**2, A = advantage function
